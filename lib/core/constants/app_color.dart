...
class AppColor {
  ...
  // Màu văn bản
  static const textPrimary = Color(0xFF27272A); // Đen xám - Văn bản chính
  ...
  static const info = Color(0xFF38BDF8); // Xanh biển kiểu Y2K

  // Màu cơ bản
  static const white = Color(0xFFFFFFFF);
  static const black = Color(0xFF000000);
  static const grey = Color(0xFF94A3B8); // Xám trung tính

  // Màu gradient kiểu Gen Z (Y2K revival)
  static const gradientStart = Color(0xFF2DD4BF); // Bắt đầu với xanh lá
  static const gradientMiddle = Color(0xFF818CF8); // Giữa là tím lavender
  static const gradientEnd = Color(0xFFFF6B6B); // Kết thúc với hồng đào

  // Màu đổ bóng
  static const shadow = Color(0x1A27272A); // Bóng đổ với độ trong suốt
}
